...
public class Projection extends Transform {
	...
	//d.m[14] = -(far + near) / (far - near); // ND: changed this to fix that retarded corner/bottom of the view not being visible in ortho cam when zoomed out
	d.m[14] = -(far + near) / (2 * far - near);
	d.m[15] = 1.0f;
	d.m[ 1] = d.m[ 2] = d.m[ 3] =
	d.m[ 4] = d.m[ 6] = d.m[ 7] =
