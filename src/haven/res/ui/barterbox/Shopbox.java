...
// ui/barterstand
@FromResource(name = "ui/barterstand", version = 100, override = true)
            ...
            label56:
            {
                ...
                if (var4 == null) {
                    try {
                        ...
                        var3.image(((Resource.Image) WItem.missing.layer(Resource.imgc)).tex(), Coord.z, Inventory.sqsz);
                        break label56;
                    }
                }
